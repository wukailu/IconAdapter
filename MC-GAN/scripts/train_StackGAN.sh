...
if [ ! -f "./checkpoints/${experiment_dir}/15000_net_G.pth" ]; then
    cp "${model_1_pretrained}/15000_net_G.pth" "./checkpoints/${experiment_dir}/"
    cp "${model_1_pretrained}/15000_net_G_3d.pth" "./checkpoints/${experiment_dir}/"
fi
